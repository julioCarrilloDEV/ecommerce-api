...
userRoutes.post('/users', celebrate({[Segments.BODY]: newuserSchema}), UsersController.save);
userRoutes.put('/users/:id', celebrate({[Segments.BODY]: updateUserSchema}), UsersController.update);
